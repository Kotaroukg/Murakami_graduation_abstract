...
void draw(){
  ...
  strokeWeight(20);
  point(e_wave_1.coordinates_x,e_wave_1.coordinates_y);
  point(e_wave_2.coordinates_x,e_wave_2.coordinates_y);
...
void set_elementary_waves_lotation(){
  ...
  e_wave_2 = new Elementary_waves(255,0,0,e_wave_2_x,e_wave_2_y,false);
...
class Incident_waves{
  ...
  void check_create_elementary_waves(){
    ...
    float check_y_2 = y - (y / x) * e_wave_2.coordinates_x; 
    if(check_y_2 > e_wave_2.coordinates_x) e_wave_2.draw_flag = true;
